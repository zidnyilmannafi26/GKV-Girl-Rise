...
class FinalReflectionPutusScreen extends StatefulWidget {
  const FinalReflectionPutusScreen({super.key});

  @override
  State<FinalReflectionPutusScreen> createState() =>
      _FinalReflectionPutusScreenState();
}

class _FinalReflectionPutusScreenState extends State<FinalReflectionPutusScreen>
                      ...
                      child: Column(
                        children: [
                          ...
                          FadeTransition(
                            opacity: _step1Anim,
                            child: Text(
                              'Setiap keputusan membutuhkan keberanian. Hari ini kamu memilih memberi waktu bagi dirimu sendiri untuk tumbuh, belajar, dan mempersiapkan masa depan dengan lebih matang. Perjalananmu mungkin tidak mudah. Namun, setiap langkah yang kamu ambil hari ini dapat membuka lebih banyak kesempatan di masa depan.',
