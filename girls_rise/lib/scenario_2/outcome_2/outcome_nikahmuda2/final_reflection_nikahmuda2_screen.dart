...
class FinalReflectionNikahMuda2Screen extends StatefulWidget {
  const FinalReflectionNikahMuda2Screen({super.key});

  @override
  State<FinalReflectionNikahMuda2Screen> createState() =>
      _FinalReflectionNikahMuda2ScreenState();
}

class _FinalReflectionNikahMuda2ScreenState
    extends State<FinalReflectionNikahMuda2Screen> with TickerProviderStateMixin {
                      ...
                      child: Column(
                        children: [
                          ...
                          FadeTransition(
                            opacity: _step1Anim,
                            child: Text(
                              'Setiap keputusan memiliki alasan dan cerita di baliknya. Hari ini kamu memilih jalan yang membawa tanggung jawab besar lebih awal dalam hidupmu. Perjalanan yang kamu lalui mungkin memberi tantangan yang tidak pernah kamu bayangkan. Namun, ini menjadi pengingat bahwa keputusan besar sering kali membutuhkan kesiapan emosional, pendidikan, dan ekonomi yang matang.',
                          ...
                          FadeTransition(
                            opacity: _step2Anim,
                            child: Text(
                              'Tidak semua pilihan membawa hasil yang sama. Namun, setiap pilihan selalu membawa pelajaran yang berharga. Masa depan tidak ditentukan oleh seberapa cepat kamu mengambil keputusan besar, tetapi oleh seberapa siap kamu menjalaninya.',
                              textAlign: TextAlign.center,
                              style: GoogleFonts.lora(
                                fontSize: 13.0 * scale,
                                height: 1.5,
